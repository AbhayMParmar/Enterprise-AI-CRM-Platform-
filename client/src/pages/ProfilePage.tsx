      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200 dark:border-zinc-800">
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="p-2 rounded-xl bg-white dark:bg-zinc-800 border border-slate-200/90 dark:border-zinc-700 text-slate-600 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-zinc-700 transition-all shadow-xs cursor-pointer flex items-center gap-1.5 text-xs font-semibold"
          >
        ...
        <div className="hidden sm:flex items-center gap-2">
          <span className="px-3 py-1 rounded-full bg-blue-50 dark:bg-purple-950/80 border border-blue-100 dark:border-purple-800 text-blue-700 dark:text-purple-300 text-xs font-bold flex items-center gap-1.5">
